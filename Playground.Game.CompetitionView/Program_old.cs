...
//
// class Program_old(IMyLogger logger)
// {
...
//                 }
//                 catch (InvalidGameStatusException)
//                 {
//                 }
...
//             _ => throw new InvalidGameStatusException($"Unknown Game.Status case '{gameUpdatedDto.Status}'.")
//         };
//     }
//
...
// }
//
// public class InvalidGameStatusException(string? message = null) : Exception(message);